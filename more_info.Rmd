...
The table depicts counties with the 10 highest and lowest mean wage in 2017. Hamilton(1) and Schuyler(1), the lightest colored counties on the map, have the least mean wages. The lowest waged 10 counties range from white(1) to orange(4), and the highest from orange(4) to dark-red(7). 

The data is surprising as people usually associate poorer regions with more crime. However, the data demonstrates a positive association between wage and crime rates per capita. Does this correlation prove causation, or is this association a mere coincidence? 
...
How ethnically diverse are counties with the most crime rate?
